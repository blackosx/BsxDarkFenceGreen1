...
<img src="https://github.com/blackosx/BsxDarkFenceGreen1_/blob/main/preview_ui.jpg" alt="theme_preview" border="0">

<img src="https://github.com/blackosx/BsxDarkFenceGreen1_/blob/main/preview_password.jpg" alt="theme_preview" border="0">
...
**Using this theme**<br>
This repository contains a Blackosx directory with a sub-directory BsxDarkFenceGreen1_ which contains all necessary ICNS files for the theme.
...
- then just add the BsxDarkFenceGreen1_ directory

Either way, for this theme you will want to end up having
EFI/OC/Resources/Image/Blackosx/BsxDarkFenceGreen1_

You can switch the icon set used by OpenCanopy by changing the 'PickerVariant' key in OpenCore's config.plist to match the vendor and theme name of the icon set you want to display. So to instruct OpenCanopy to use this icon set you want to set the PickerVariant key to Blackosx\BsxDarkFenceGreen1_

```
                <key>PickerVariant</key>
                <string>Blackosx\BsxDarkFenceGreen1_</string>
```
